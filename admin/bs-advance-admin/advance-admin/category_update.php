...
<body>
    <div id="wrapper">
     ...
     if(isset($_GET['up'])){
     $select_pro=$get_data->select_id_category($_GET['up']);
    foreach ($select_pro as $i_pr){
    ?>
                            <form role="form" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>ID Category</label>
                                            <input class="form-control" type="text" name="txt_ID_Cate" value="<?php echo $i_pr['ID_category']?>" >
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>Name Category</label>
                                            <input class="form-control" type="text" name="txt_Name_Cate" value="<?php echo $i_pr['NameCatye']?>" >
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>Description</label>
                                            <input class="form-control" type="text" name="txt_Description" value="<?php echo $i_pr['Description']?>" >
...
<?php
    ...
    if(isset($_POST['txtsub'])){// kiểm tra nút đăng ký đã ấn hay chưa
        ...
        window.location='category_select.php';
        </script>";
