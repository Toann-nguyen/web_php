       ...
       <nav class="navbar-default navbar-side" role="navigation">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-desktop "></i>UI Elements <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="seelect_order_admin.php"><i class="fa fa-toggle-on"></i>Select check order in Nimo</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">SELECT PRODUCT</h1>
                                ...
                                <table class="table">
                                 ...
                                 foreach($select as $se)                            
                                       ...
                                       <tr>
                                        ...
                                        <td><?php if($se['total'] ==0) {echo "Chua hoan duyet yeu cau"; }
                                                    else{
                                                        echo "Da duoc duyet";
                                                    }
                                                    ?></td>
                                        <td><?php echo $se['tinhtrang']?></td>
                                        <td><?php 
                                            if($se['month']==1){
                                                echo "quý 1";
                                            }
                                        ...
                                        ?></td>
                                        <td><?php echo"Có sản phẩm cùng quý :". $se['count']?></td>
