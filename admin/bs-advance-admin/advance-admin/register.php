                          ...
                          <form role="form" method ="POST" enctype ="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  class="form-control"  name="txtaddress">
                                                <option value="Hai Noi">Hà Nội</option>
                                    ...
                                    {
                                        $register_user=$get_data->register($_POST['txtuser'], $_POST['txtpass'], $_POST['txtaddress'], $_FILES['txtfile']['name'], $_POST['txtgen'], $c_check, $_POST['txtemail']);
