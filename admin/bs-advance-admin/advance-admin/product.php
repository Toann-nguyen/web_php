                        ...
                        <div class="panel-body">
                          <form role="form" method = "POST" enctype ="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <p class="help-block">Input text here.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Number pro</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  class="form-control"  name="txtcate">
                                                <option value="dgd">Đồ gia dụng </option>
                                                <option value="du">Đồ uống</option>
                                                <option value="dht">Đồ học tập</option>
                                                <option value="gv">Gia vị</option>
                                                <option value="dav">Đồ ăn vặt</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Date</label>
                                    ...
                                    include('control.php');
                                    $get_data=new data();
                                    $insert= $get_data->insert_product($_POST['txtname'],$_POST['txtnumber'],$_FILES['txtfile']['name'],$_POST['txtcate'],$_POST['txtdate'],$_POST['txtprice'],$_POST['txtdes']);
