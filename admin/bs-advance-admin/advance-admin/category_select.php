       ...
       <nav class="navbar-default navbar-side" role="navigation">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Category Table</h1>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo $se['ID_category']?></td>
                                                <td><?php echo $se['NameCatye']?></td>
                                                <td><?php echo $se['Description']?></td>
                                                <td> <a href="category_update.php?up=<?php echo $se['ID_category']?>">Up</a></td>
                                                <td> <a href="category_delete.php"
                                                onClick ="if(confirm('Bạn có chắc muốn xóa?')) return true; else return false;">Delete</a></td>
                                            </tr>
                                            <?php
                                            }
                                            ?>
