...
<body>
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST">
                                        <div class="form-group">
                                            <label>NameCatype</label>
                                            <input class="form-control" type="text" name="txtNC">
                                                                             
                                        </div>
                                        <div class="form-group">
                                            <label>Description</label>
                                            <input class="form-control" type="text" name="txtD">
    ...
    if(isset($_POST['txtsub'])){// kiểm tra nút đăng ký đã ấn hay chưa
        $in_category=$get_data->insert_category($_POST['txtNC'],$_POST['txtD']);
        if($in_category) echo"<script> alert('Thanh cong');
        </script>";
