...
<?php 
include('./bs-advance-admin/advance-admin/assets/control.php');
// $get_data = new data_user1;

$_check = "";
foreach($_POST['txtcheck'] as $is_check){
    $_check .= $is_check;
}
            move_uploaded_file($_FILES['txtfile']['tmp_name'], 'upload/'.$_FILES['txtfile']['name']);
            $se_user = $get_data->select_user1($_POST['txtuser']);
