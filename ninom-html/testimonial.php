...
<body class="sub_page">
  ...
  <section class="client_section layout_padding">
    <div class="container ">
      ...
      <div id="carouselExample2Controls" class=" slide" data-ride="carousel">
      <?php 
       include('../admin/bs-advance-admin/advance-admin/control.php');
                  $get_data=new data_product();
                  $id =0;
                  $select=$get_data->select_product_testimonial();
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="client_container layout_padding-top">
              <div class="img-box">
                 <img  src="../admin/bs-advance-admin/advance-admin/upload/<?php echo $se['picture']?>">
              </div>
              <div class="detail-box">
                <h5>
                  <?php 
                 echo "Mặt hàng thứ ". $id = $id +1; ?>
                </h5>
                <p>
                  <span>
                <?php echo"So luong  ".$se['number']?>
                  </span>
