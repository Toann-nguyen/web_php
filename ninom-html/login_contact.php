            ...
            <form action="" role="form" method="POST" enctype="multipart/form-data">
              <div class="contact_form-container">
                <div>
                  ...
                  <div>
                    <a href="Forget_pass_contact.php">ForgetPassWord?</a>
                  </div>
                </div>
              </div>
            </form>
...
//  $login=$get_data->login($_POST['txtname'],$_POST['txtpass']);
if(isset($_POST['txtsub'])){
      {
         if(!isset($_POST['txtname']) || !isset($_POST['txtpass']) || empty($_POST['txtname']) || empty($_POST['txtpass']))
         {
