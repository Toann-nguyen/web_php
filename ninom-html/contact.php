          ...
          <div class="col-lg-4 offset-lg-2 col-md-5 offset-md-1">
            <form action="" role="form" method="POST" enctype="multipart/form-data">
              <div class="contact_form-container">
                <div>
                  <div>
                    <input type="text" placeholder="Full Name" name="inp_full_name" />
                  </div>
                  <div>
                    <input type="email" placeholder="Email" name="inp_email" />
                  </div>
                  <div>
                    <input type="text" placeholder="Phone Number"  name="inp_phone_number"/>
                  </div>
                  <div>
                    <input type="text" class="message_input" placeholder="Message" name="inp_message" />
                  </div>
                   <div>
                    <input type="password" placeholder="Password"  name="inp_password"/>
                  </div>
                  <div>
                    <button name="txtsub" type="submit">
                      Send
                    </button>
                  </div>
                </div>
  ...
  include('../admin/bs-advance-admin/advance-admin/control.php');
   ...
   $get_data=new data_contact();
    if(isset($_POST['txtsub'])){// kiểm tra nút đăng ký đã ấn hay chưa
        $in_contact=$get_data->insert_contact(
          $_POST['inp_full_name'],
           $_POST['inp_email'],
            $_POST['inp_phone_number'],
             $_POST['inp_message'],
            $_POST['inp_password']);
